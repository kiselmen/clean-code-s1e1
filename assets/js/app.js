...
var taskInput = document.querySelector(".list-item_new");//Add a new task.
var addButton = document.querySelectorAll(".list-item__btn")[0];//first button
...
//select ListItems children
    var checkBox = taskListItem.querySelector(".list-item__status");
